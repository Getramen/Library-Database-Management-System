package com.team5.librarydatabasemanage.views.addpublisher;
...
@Route(value = "my-view15", layout = MainLayout.class)
public class AddPublisherView extends Composite<VerticalLayout> {
    ...
    public AddPublisherView() {
        ...
        formLayout3Col2.setResponsiveSteps(new ResponsiveStep("0", 1), new ResponsiveStep("250px", 2),
                new ResponsiveStep("500px", 3));
        textField.setLabel("Publisher ID");
        textField.setWidth("min-content");
        textField2.setLabel("Publisher Name");
        textField2.setWidth("min-content");
        emailField.setLabel("Publisher Email");
        emailField.setWidth("min-content");
        textField3.setLabel("Publisher Tel No");
        textField3.setWidth("min-content");
        buttonPrimary.setText("Add Publisher");
        ...
        buttonPrimary.addClickListener(event -> {
            ...
            String publisherID = (textField.getValue());
            String publisherName = textField2.getValue();
            String publisherEmail = emailField.getValue();
            String publisherTelNo = textField3.getValue();

            String insertQuery = "INSERT INTO Publisher (Publisher_ID, Publisher_name, E_mail, Tel_no) VALUES ("
                    + publisherID
                    + ",'" + publisherName + "', '" + publisherEmail + "', '" + publisherTelNo + "');";
            try {
                ConnectDatabase.statement.executeUpdate(insertQuery);
                Notification.show("Publisher Added successfully");
            } catch (SQLException e) {
                Notification.show("Publisher add failed: " + e.getMessage());
                e.printStackTrace();
            }
