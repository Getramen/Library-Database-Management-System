package com.team5.librarydatabasemanage.views.viewlibrarian;
...
@Route(value = "my-view22", layout = MainLayout.class)
public class ViewLibrarianView extends Composite<VerticalLayout> {
    ...
    public ViewLibrarianView() {
        ...
        setMultiSelectListBoxLibrarianNameData(textItems2);
        hr7.setMinWidth("5px");
        ...
        setMultiSelectListBoxLibrarianSurnameData(textItems3);
        hr9.setMinWidth("5px");
        ...
        setMultiSelectListBoxTelNoData(textItems5);
        ...
        setMultiSelectListBoxSalaryData(textItems8);
        ...
        setMultiSelectListBoxSexData(textItems9);
    ...
    private void getSelectListBoxViewLibrarianDatas(List items, String listName) {
        List<Long> librarianID = new ArrayList<>();
        List<String> librarianName = new ArrayList<>();
        List<String> librarianSurname = new ArrayList<>();
        List<String> address = new ArrayList<>();
        List<String> telNo = new ArrayList<>();
        List<String> dutyPeriod = new ArrayList<>();
        List<String> workLocation = new ArrayList<>();
        List<Double> salary = new ArrayList<>();
        List<String> sex = new ArrayList<>();
        try {
            String query = "SELECT * FROM view_Librarian";
            ...
            while (resultSet.next()) {
                ...
                librarianSurname.add(resultSet.getString("Librarian_surname"));
                address.add(resultSet.getString("Address"));
                telNo.add(resultSet.getString("Tel_no"));
                dutyPeriod.add(resultSet.getString("Duty_period"));
                workLocation.add(resultSet.getString("Work_location"));
        ...
        switch (listName) {
            ...
            case "librarianNameItems":
                ...
                break;
            case "librarianSurnameItems":
                for (String surname : librarianSurname) {
                    items.add(surname);
                }
                break;
            case "addressItems":
            ...
            case "telNoItems":
                ...
                break;
            case "dutyPeriodItems":
                for (String period : dutyPeriod) {
                    items.add(period);
                }
                break;
            case "workLocationItems":
                for (String location : workLocation) {
                    items.add(location);
                }
                break;
            case "salaryItems":
                for (Double sal : salary) {
                    items.add(Double.toString(sal));
                }
                break;
            case "sexItems":
                for (String s : sex) {
    ...
    private void setMultiSelectListBoxLibrarianIDData(MultiSelectListBox multiSelectListBox) {
        ...
        getSelectListBoxViewLibrarianDatas(librarianIDItems, "librarianIDItems");
    ...
    private void setMultiSelectListBoxLibrarianNameData(MultiSelectListBox multiSelectListBox) {
        ...
        getSelectListBoxViewLibrarianDatas(librarianNameItems, "librarianNameItems");
        multiSelectListBox.setItems(librarianNameItems);
    }

    private void setMultiSelectListBoxLibrarianSurnameData(MultiSelectListBox multiSelectListBox) {
        List<String> librarianSurnameItems = new ArrayList<>();
        getSelectListBoxViewLibrarianDatas(librarianSurnameItems, "librarianSurnameItems");
        multiSelectListBox.setItems(librarianSurnameItems);
    }
    ...
    private void setMultiSelectListBoxAddressData(MultiSelectListBox multiSelectListBox) {
        ...
        getSelectListBoxViewLibrarianDatas(addressItems, "addressItems");
    ...
    private void setMultiSelectListBoxTelNoData(MultiSelectListBox multiSelectListBox) {
        ...
        getSelectListBoxViewLibrarianDatas(telNoItems, "telNoItems");
        multiSelectListBox.setItems(telNoItems);
    }

    private void setMultiSelectListBoxDutyPeriodData(MultiSelectListBox multiSelectListBox) {
        List<String> dutyPeriodItems = new ArrayList<>();
        getSelectListBoxViewLibrarianDatas(dutyPeriodItems, "dutyPeriodItems");
        multiSelectListBox.setItems(dutyPeriodItems);
    }

    private void setMultiSelectListBoxWorkLocationData(MultiSelectListBox multiSelectListBox) {
        List<String> workLocationItems = new ArrayList<>();
        getSelectListBoxViewLibrarianDatas(workLocationItems, "workLocationItems");
        multiSelectListBox.setItems(workLocationItems);
    }

    private void setMultiSelectListBoxSalaryData(MultiSelectListBox multiSelectListBox) {
        List<String> salaryItems = new ArrayList<>();
        getSelectListBoxViewLibrarianDatas(salaryItems, "salaryItems");
        multiSelectListBox.setItems(salaryItems);
    }

    private void setMultiSelectListBoxSexData(MultiSelectListBox multiSelectListBox) {
        List<String> sexItems = new ArrayList<>();
        getSelectListBoxViewLibrarianDatas(sexItems, "sexItems");
